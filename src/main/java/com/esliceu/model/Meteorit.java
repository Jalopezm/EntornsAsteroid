...
public class Meteorit {
    ...
    public Meteorit(String nom, String nomCientific, Double velocitat, Double velocitatMinima, Double velocitatMaxima, Boolean esPerillos, int indexPerillositat, Double distancia, Double distanciaMinima, Double distanciaMaxima, Double diametre, Double altura, Double amplada, Double profunditat, String[] composicio, Double radi, Double orbita, String[] planetesPropers, Date primeraVisualitzacio, Date diaMesProximALaTerra) {
        this.nom = nom;
